...
In this chapter, I will use the goal-directed design process \citep{Cooper2007} to analyse the problem presented by the project. Firstly, I will create personas to represent potential users of the final application. I will then write scenarios describing how these personas would ideally interact with the application in order to achieve their goals. Finally, I will define the functional and non-functional requirements of the application, using the scenarios and findings of the literature review as motivation. 

\section{Personas} 

Unfortunately I did not have enough time to perform the necessary fieldwork in order to make 'rigorous' personas. Therefore, I will have to create 'provisional' personas based on my best guesses about behaviours, motivations and goals. 

Cooper et al. warn of some potential issues to avoid when creating provisional personas \citep{Cooper2007}. It is important to avoid focusing on the wrong design target. Even if you are focusing on the correct target, you must be careful to ensure that key behaviours that could differentiate the product aren't missed. It is important to focus on behaviours and motivations rather than demographics.
